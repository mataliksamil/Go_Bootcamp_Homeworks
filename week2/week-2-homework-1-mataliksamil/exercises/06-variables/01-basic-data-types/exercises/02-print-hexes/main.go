...
func main() {
	...
	fmt.Println("1 ) ", 0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9)
	fmt.Println("2 ) ", 0xa, 0xb, 0xc, 0xd, 0xe, 0xf)
	fmt.Println("3 ) ", 0x11) // 17
	fmt.Println("4 ) ", 0x19) // 25
	fmt.Println("4 ) ", 0x32) // 50
	fmt.Println("4 ) ", 0x64) // 100
}
